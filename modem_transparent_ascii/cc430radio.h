...
#define CCDEF_FSCTRL1    0x0A   // Frequency synthesizer control.
...
#define CCDEF_MDMCFG4         0x2D   // Modem Configuration. Speed = 250 kbps 

#define CCDEF_MDMCFG3    0x3B   // Modem configuration.
#define CCDEF_MDMCFG2    0x73   // Modem configuration.
#define CCDEF_MDMCFG1    0x22   // Modem configuration.
#define CCDEF_MDMCFG0    0xF8   // Modem configuration.
#define CCDEF_CHANNR     0x14   // Channel number.
#define CCDEF_DEVIATN    0x00   // Modem deviation setting (when FSK modulation is enabled).
#define CCDEF_FREND1     0xB6   // Front end RX configuration.
...
#define CCDEF_FOCCFG     0x1D   // Frequency Offset Compensation Configuration.
#define CCDEF_BSCFG      0x1C   // Bit synchronization Configuration.
#define CCDEF_AGCCTRL2   0xC7   // AGC control.
#define CCDEF_AGCCTRL1   0x00   // AGC control.
#define CCDEF_AGCCTRL0   0xB0   // AGC control.
#define CCDEF_FSCAL3     0xEA   // Frequency synthesizer calibration.
...
#define CCDEF_PKTCTRL1   0x05   // Packet automation control.
...
class CC430RADIO
{
  ...
  public:
     ...
     */
    void init(uint8_t freq=CFREQ_915, uint8_t mode=0);
